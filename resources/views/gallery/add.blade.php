...
@section('title', 'Dodaj sliku')

@section('content')
<h1 class="text-center p-3 fw-bold">Dodaj sliku</h1>
    ...
    <div class="container-fluid p-2">
        ...
        <div class="form-group row">
            ...
            <div class=" form-group row">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="img_desc" id="img_desc" placeholder="Opis">
                </div>
            </div>
            ...
            <div class=" form-group row">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="img_desc_en" id="img_desc_en" placeholder="Opis engleski">
                </div>
            </div>

                <div class="form-group row">
                    <label for="image" class="col-sm-5 col-form-label">Slika</label>
                    <div class="col-sm-12">
                        <input type="file" class="form-control" name="image" id="image"  accept="image/*" placeholder="Opis engleski">
                    </div>
                </div>
